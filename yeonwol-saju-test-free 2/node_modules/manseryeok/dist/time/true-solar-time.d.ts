...
/** 한반도 평균 자오선 (기본 출생 경도) */
export declare const DEFAULT_LONGITUDE = 127.5;
 ...
 */
export declare function resolveInstant(year: number, month: number, day: number, hour: number, minute: number, options?: TrueSolarTimeOptions): ResolvedInstant;
